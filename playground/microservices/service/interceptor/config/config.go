...
type Config struct {
	...
	HttpPort uint64 `name:"http-port" help:"Http Port" env:"HTTP_PORT" default:"8090"`
	GrpcPort uint64 `name:"grpc-port" help:"Grpc Port" env:"GRPC_PORT" default:"8090"`
	...
	WarehouseAddress   string `name:"warehouse-address" help:"Address of warehouse" env:"WAREHOUSE_ADDRESS" default:"http://localhost:8092"`
	CustomerAddress    string `name:"customer-address" help:"Address of customer" env:"CUSTOMER_ADDRESS" default:"http://localhost:8093"`
